    ...
    fun assertShoppingCartInfo(shoppingCartInfoUI: ShoppingCartInfoUI, context: Context) {
        ...
        shoppingCartInfoUI.products.forEachIndexed { index, product ->
            ...
            product.prices.forEach {
                ...
                assertTextVisible(context.getString(R.string.product_details_amount, it.amount.toString(), it.currency))
            }
        }
        if (shoppingCartInfoUI.specialProduct != null) {
            ...
            assertDisplayed(context.getString(R.string.product_details_amount,
        ...
        assertDisplayed(R.id.totalAmountShoppingCart, context.getString(R.string.shopping_cart_total_amount,
                shoppingCartInfoUI.totalAmount, shoppingCartInfoUI.currency))
    }
